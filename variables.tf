...
variable "fixed_response_content_type" {
  default     = ""
  description = "Content type for extra fixed-response listener rule"
  type        = string
}
...
variable "fixed_response_path_pattern" {
  default     = [""]
  description = "path pattern for extra fixed-response listener rule"
  type        = list(string)
}

variable "fixed_response_status_code" {
  default     = ""
  description = "status code for extra fixed-response listener rule"
  type        = string
}

variable "add_https_fixed_response_extra_rule" {
  default     = false
